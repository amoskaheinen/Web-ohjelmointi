...
// your code here
const targetElement = document.getElementById('target') || document.body;
...
navigator.geolocation.getCurrentPosition(
  position => {
    ...
    restaurants.forEach(restaurant => {
      ...
      listItem.innerHTML = `
                ...
                <small>Etäisyys (yksikköä): ${restaurant.distance.toFixed(4)}</small>
            `;
  ...
  error => {
    ...
    targetElement.innerHTML =
      '<p>Sijainnin haku epäonnistui. Salli selaimesi paikannus ja päivitä sivu.</p>';
  }
);
